...
const MaterialSettings: React.FC<MaterialSettingsProps> = ({ onSettingsChange }) => {
        ...
        {expandedSections.material && (
          <View style={styles.sectionContent}>
            ...
            >
              ...
              <Ionicons
                name={expandedSections.metalColor ? "chevron-down" : "chevron-up"}
                size={20}
                color="#666666"
                style={styles.expandIcon}
              />
            ...
            {expandedSections.metalColor && (
              <View style={styles.metalColorContent}>
                <View style={styles.colorGrid}>
                  {['#FFD700', '#C0C0C0', '#B87333', '#4682B4', '#8B4513', '#CD7F32'].map((color, index) => (
                    <TouchableOpacity
                      key={`metal-${index}`}
                      style={[styles.colorItem, settings.color === color && styles.selectedColor]}
                      onPress={() => setSettings(prev => ({ ...prev, color }))}
                    >
