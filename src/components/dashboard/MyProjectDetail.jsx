...
const MyProjectDetail = () =>{
   ...
   const[itemData, setItemData] = useState(designs);
        ...
        <View style={Style.Container}>
            ...
            <View style={Style.Button2}>
                <View style={Style.NewDesign}>
                    <TouchableOpacity style={Style.rowRow}>
                        <View style={Style.backgroundIcon}>
                            <MaterialCommunityIcons name="border-color" size={25} style={Style.Icon}/> 
                        </View>
                ...
                <View style = {Style.Upload}>
                    <TouchableOpacity style={Style.rowRow}>
                        <View style={Style.backgroundIcon}>
                            <Ionicons name="cloud-upload-outline" size={25} style={Style.Icon2}/> 
                        </View>
                    ...
                    if(item.edited <= 3){
                        return (
                            <View style={{paddingRight: 30, marginTop: 20,}}>
                                <Image source={{ uri: item.imageUrl }} style={Style.ImageRecent}/>
                                <Text style={Style.Text3}>{item.name}</Text>
                                <Text style={{fontSize: 10,}} >Edited {item.edited} days ago</Text>
                            </View>
                        );
                      }
                   }
            ...
            <View style={Style.AllDesign}>
                ...
                <View style={Style.buttonAllDesign}>
                    <Picker style={Style.picker} selectedValue={selectedSort} onValueChange={onChangeSortValue} >
...
const Style = StyleSheet.create({
    ...
    row: {
        flexDirection: 'row', // Đưa các phần tử về cùng một hàng
