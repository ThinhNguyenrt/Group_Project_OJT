    ...
    <View style={{ flex: 1, flexDirection: "row", backgroundColor: "#F5F5F5" }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}>
          <AntDesign name="close" size={24} color="black" style={{ marginRight: 10 }}/>
            ...
            <Image 
              source={{ uri: 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTvKExDXfDDQQRrE3tZCGWGSPhxmVXIqYjEEVaMp4EZkqm3bSo7' }} 
          ...
          <View style={{ flexDirection: 'row', marginLeft:550 }}>
            <TouchableOpacity style={{ backgroundColor: 'white', padding: 10, borderRadius: 12, marginRight: 10, flexDirection: 'row', alignItems: 'center' ,width:110}}>
              <AntDesign name="hearto" size={16} color="black" style={{ marginRight: 5 }} />
              <Text>Like</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ backgroundColor: 'black', padding: 10, borderRadius: 12 , width:110}}>
        ...
        <View style={{ alignItems: 'center', marginTop: 20 }}>
          ...
          <Text style={{ color: 'gray', textAlign: 'center', marginBottom: 10 }}>Photo cute kawaii house 3d render illustration in pastel colors</Text>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <TouchableOpacity style={{ backgroundColor: 'white', borderRadius: 20, padding: 10, marginRight: 50 }}>
              <AntDesign name="left" size={24} color="black" />
            </TouchableOpacity>
            <Image 
              source={{ uri: 'https://img.freepik.com/free-photo/3d-rendering-cartoon-house_23-2150188294.jpg?w=360' }} 
              style={{ width: 360, height: 360, borderRadius: 10 }} 
            />
            <TouchableOpacity style={{ backgroundColor: 'white', borderRadius: 20, padding: 10, marginLeft: 50 }}>
              <AntDesign name="right" size={24} color="black" />
            </TouchableOpacity>
          </View>
        </View>
        
        <Text style={{ fontWeight: "bold", marginBottom: 10 ,marginTop:20, fontSize:15,marginLeft:50}}>You might also like</Text>
        <View style={{ padding: 10, borderRadius: 10 ,backgroundColor:"white",width:680,marginLeft:50}}>
          <ScrollView horizontal>
            {houseImages.map((image, index) => (
              <Image key={index} source={{ uri: image }} style={{ width: 150, height: 110, marginRight: 20 ,borderRadius:10}} />
            ))}
          </ScrollView>
        </View>
      </View>
      ...
      {/* Right Side - Feedback */}
      <View style={{ flex: 1, backgroundColor: "#F5F5F5", padding: 20, borderLeftWidth: 1, borderColor: "#ddd" }}>
        ...
        <ScrollView>
          {feedbacks.map((item) => (
            <View key={item.id} style={{ flexDirection: "row", alignItems: "center", marginVertical: 10 }}>
              <Image source={{ uri: item.avatar }} style={{ width: 40, height: 40, borderRadius: 20, marginRight: 10 }} />
              <View>
        ...
        <TextInput
          ...
          style={{ marginTop: 10, padding: 10, borderRadius: 10 ,backgroundColor:"white",height:100}}
        />
      </View>
    </View>
  );
