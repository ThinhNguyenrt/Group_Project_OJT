...
import SlideBar from "../editTools/SlideBar";
    ...
    >
      ...
      {/* <View style={styles.toggleContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => toggleMode("Swatches")}
        >
          <Image source={SwatchesIcon} style={styles.icon} />
          <Text
            style={[
              styles.toggleText,
              selectedMode === "Swatches" && styles.selectedText,
            ]}
          >
            Swatches
          </Text>
        ...
        <TouchableOpacity
          style={styles.toggleOption}
          onPress={() => toggleMode("Color Mixer")}
        >
          <Image source={ColorMixerIcon} style={styles.icon} />
          <Text
            style={[
              styles.toggleText,
              selectedMode === "Color Mixer" && styles.selectedText,
            ]}
          >
            Color Mixer
          </Text>
